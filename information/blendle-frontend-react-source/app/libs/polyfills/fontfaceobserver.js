/* eslint-disable */
/**
 * https://github.com/bramstein/fontfaceobserver/blob/f0997637bc7531ad95365786e67f243788315cbd/fontfaceobserver.standalone.js
 */
    ...
    return new Promise(function(a, b) {
      ...
      if (E) {
        ...
        m(function() {
              ...
              (b = f != g && f != h && g != h) ||
                ...
                (b =
                  ...
                  ((f == u && g == u && h == u) ||
                    ...
                    (f == w && g == w && h == w)))),
                (b = !b);
            b && (null !== d.parentNode && d.parentNode.removeChild(d), clearTimeout(q), a(c));
          }
          function G() {
            if (new Date().getTime() - F >= C)
              ...
              if (!0 === a || void 0 === a)
                (f = e.a.offsetWidth), (g = n.a.offsetWidth), (h = p.a.offsetWidth), t();
              q = setTimeout(G, 50);
            }
          }
          var e = new r(k),
          ...
          x(e, I(c, '"' + c.family + '",sans-serif'));
          z(n, function(a) {
            g = a;
            t();
          });
          x(n, I(c, '"' + c.family + '",serif'));
          z(p, function(a) {
            h = a;
            t();
          });
          x(p, I(c, '"' + c.family + '",monospace'));
        });
    });
  };
...
// WEBPACK FOOTER //
// ./src/js/app/libs/polyfills/fontfaceobserver.js